    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "positive_prompt": ("STRING", {"default": "", "multiline": True, "placeholder": "prompt_positive: Leave blank if using CONDITIONING inputs"}),
                "negative_prompt": ("STRING", {"default": "", "multiline": True, "placeholder": "prompt_negative: Leave blank if using CONDITIONING inputs"}),
